...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { cargaPrev: @atividade.cargaPrev, cargaReal: @atividade.cargaReal, dataFim: @atividade.dataFim, dataInicio: @atividade.dataInicio, descricao: @atividade.descricao, titulo: @atividade.titulo } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { cargaPrev: @atividade.cargaPrev, cargaReal: @atividade.cargaReal, dataFim: @atividade.dataFim, dataInicio: @atividade.dataInicio, descricao: @atividade.descricao, titulo: @atividade.titulo } }
