...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { area: @projeto.area, dataFin: @projeto.dataFin, dataInicio: @projeto.dataInicio, tipoProjeto: @projeto.tipoProjeto, titulo: @projeto.titulo } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { area: @projeto.area, dataFin: @projeto.dataFin, dataInicio: @projeto.dataInicio, tipoProjeto: @projeto.tipoProjeto, titulo: @projeto.titulo } }
